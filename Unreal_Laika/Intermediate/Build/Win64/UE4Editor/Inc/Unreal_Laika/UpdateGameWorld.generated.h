...
#ifdef UNREAL_LAIKA_UpdateGameWorld_generated_h
#error "UpdateGameWorld.generated.h already included, missing '#pragma once' in UpdateGameWorld.h"
#endif
...
public: \
	DECLARE_CLASS(AUpdateGameWorld, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/Unreal_Laika"), NO_API) \
...
#define Unreal_Laika_Source_Unreal_Laika_UpdateGameWorld_h_12_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, AUpdateGameWorld); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AUpdateGameWorld); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API AUpdateGameWorld(AUpdateGameWorld&&); \
	NO_API AUpdateGameWorld(const AUpdateGameWorld&); \
public:
...
template<> UNREAL_LAIKA_API UClass* StaticClass<class AUpdateGameWorld>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID Unreal_Laika_Source_Unreal_Laika_UpdateGameWorld_h
